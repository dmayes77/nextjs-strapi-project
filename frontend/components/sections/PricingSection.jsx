  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-semibold tracking-tight text-accent sm:text-6xl">
          Simple, Transparent Packages
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-600 sm:text-xl">
        Whether you just need a website or a full CRM-powered system, we have a
        plan to get you online and growing.
      </p>
        ...
        {pricingTiers.map((tier, tierIdx) => (
          ...
          >
            <h3
              id={tier.id}
              className={classNames(
                tier.featured ? "text-[#6a3ec1]" : "text-primary",
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ? "bg-primary text-white hover:bg-[#6a3ec1]"
                  : "text-primary ring-1 ring-inset ring-primary/20 hover:ring-primary/40",
                "mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-primary"
              )}
            >
              Get Started
            </a>
